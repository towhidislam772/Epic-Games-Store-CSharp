...
namespace WindowsFormsApp3
{
    public partial class UserControl1 : UserControl
    {
        ...
        public UserControl1()
        {
            ...
            // Attach click handlers to all clickable parts
        ...
        public void SetProduct(string name, decimal price, string imagePath)
        {
            ...
            {
                pictureBoxPhoto.Image = null; // Or set a default placeholder
            }
        }
        ...
        {
            // You need to pass the logged-in user's email to GameDetails
            // Find the parent form and get the email (assuming BrowseGame is the parent)
            string userEmail = null;
            var parentForm = this.FindForm() as BrowseGame;
            if (parentForm != null)
                userEmail = parentForm.GetLoggedInEmail(); // Add this method to BrowseGame
