...
namespace WindowsFormsApp3
{
    public partial class ForgetPassword : Form
    {
        ...
        {
            pnlQstn.Visible = true;   // Start with question panel
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=TOWHID\\SQLEXPRESS;Initial Catalog=Faw;Integrated Security=True"))
            {
                con.Open();
            ...
            using (SqlConnection con = new SqlConnection("Data Source=TOWHID\\SQLEXPRESS;Initial Catalog=Faw;Integrated Security=True"))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    if (rows > 0)
                    {
                        ...
                        // show updated password in lblPassword
